...
export const metadata: Metadata = {
  title: "Account event text messages — RelayKit",
  description:
  ...
  alternates: { canonical: `/messages/${URL_SLUG}` },
};

export default function AccountEventsLanding() {
  return (
    <div>
      <DevToolsHero />
      <StatusBand />
