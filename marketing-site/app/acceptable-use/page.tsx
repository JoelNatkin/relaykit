    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="mt-8">
        ...
        <div className="mt-6 space-y-6">
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-text-tertiary">
              <li>
              ...
              <li>
                <strong className="font-semibold text-text-secondary">Hate:</strong>{" "}
      ...
      <section className="mt-8">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5 text-base text-text-tertiary">
              <li>
                <strong className="font-semibold text-text-secondary">
            ...
            <p className="mt-3 text-base leading-relaxed text-text-tertiary">
              ...
              <strong className="font-semibold text-text-secondary">not</strong>{" "}
      ...
      <section className="mt-8">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            <ul className="mt-2 list-disc space-y-1.5 pl-5 text-base text-text-tertiary">
              <li>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border-secondary">
                    ...
                    <th className="py-2 text-left font-semibold text-text-secondary">
                      Description
                    </th>
                  </tr>
                </thead>
      ...
      <section className="mt-8">
        ...
        <p className="mt-4 text-base leading-relaxed text-text-tertiary">
          ...
          available at relaykit.ai/acceptable-use.
        </p>
        <p className="mt-3 text-base leading-relaxed text-text-tertiary">
      ...
      <section className="mt-8">
        ...
        <p className="mt-4 text-base leading-relaxed text-text-tertiary">
          ...
          <strong className="font-semibold text-text-secondary">before</strong>{" "}
