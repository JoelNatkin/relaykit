...
// Category landing hero (bucket 2a). Eyebrow / H1 / body come from the registry;
// the CTAs, anchors, and trust line are constant across categories. The hero
// notification mock rotates the category's heroExamples (static when only one).
export function CategoryHero({ entry }: { entry: CategoryLanding }) {
  return (
