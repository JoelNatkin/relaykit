 ...
 * was moved here from /prototype/components/ when the prototype's
 ...
 *
 * Ported verbatim from the prototype original. No transformation. The
 * PLAYBOOK_FLOWS object below contains the appointments flow only;
 * additional categories arrive with Phase 2a content authoring.
 */
