...
const INDUSTRY_PATTERNS: IndustryPattern[] = [
  {
    ...
    message: "US carriers don't allow cannabis messaging through standard 10DLC registration. This is a carrier-level restriction across all providers.",
  },
  {
    industry: "firearms",
    label: "Firearms",
    ...
    message: "US carriers don't allow firearms messaging through standard 10DLC registration. This is a carrier-level restriction across all providers.",
  },
  {
    industry: "healthcare",
    label: "Healthcare",
    ...
    message: "Healthcare messaging involves patient data protections we can't support yet. Join our waitlist and we'll reach out when this changes.",
  },
  {
    industry: "legal",
    label: "Legal",
    ...
    message: "Carriers scrutinize legal messaging closely. We'll structure your registration to address their review criteria \u2014 no extra steps on your part.",
  },
  {
    industry: "financial",
    ...
    message: "Financial services messaging gets extra carrier scrutiny. We'll structure your registration to address their review criteria \u2014 no extra steps on your part.",
  },
  {
    industry: "restaurant",
    label: "Restaurant",
    ...
    message: "Restaurant messaging sometimes triggers carrier review for promotional content. We'll structure your registration to cover both reservations and offers.",
  },
];
