...
const SAMPLE_MESSAGE_LABELS: Record<UseCaseId, [string, string, string]> = {
  appointments: ["Appointment confirmation", "Appointment reminder", "Post-visit follow-up"],
  orders: ["Order confirmation", "Shipping update", "Delivery confirmation"],
  verification: ["Verification code", "Login code", "Phone verified"],
  support: ["Ticket received", "Ticket status update", "Ticket resolved"],
  marketing: ["Promotional offer", "New product announcement", "Sale alert"],
  internal: ["Shift update", "Meeting reminder", "Operational alert"],
  community: ["Event announcement", "Community update", "Welcome message"],
  waitlist: ["Waitlist ready notification", "Waitlist position update", "Reservation confirmation"],
  exploring: ["Confirmation", "Reminder", "Status update"],
};
