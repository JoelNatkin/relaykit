...
- Last updated: 2026-06-02 (Session 126 — sole-proprietor customer-path question resolved: deferred at launch as a MASTER_PLAN out-of-scope scope note (no D-number); `no-ein-sole-proprietor-path` exploration promoted/retired from the active list. No new decisions.)
