...
> **How this file works:**
> - These decisions are settled and rarely referenced during prototype work.
> - CC does NOT read this file at session start.
> - If a specific archived decision is relevant, Joel will say: "Check D-[number] in DECISIONS_ARCHIVE.md."
> - Entries are still authoritative unless a later decision in DECISIONS.md explicitly supersedes them.
